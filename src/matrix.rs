...
pub const MATRIX_IDENTITY: Matrix = Matrix {
    rows: 4,
    columns: 4,
    data: [
...
impl std::ops::Mul<Tuple> for Matrix {
    ...
    fn mul(self, tuple: Tuple) -> Tuple {
        ...
        Tuple {
            x: self.get(0, 0) * tuple.x
                + self.get(0, 1) * tuple.y
                + self.get(0, 2) * tuple.z
                + self.get(0, 3) * tuple.w,
            y: self.get(1, 0) * tuple.x
                + self.get(1, 1) * tuple.y
                + self.get(1, 2) * tuple.z
                + self.get(1, 3) * tuple.w,
            z: self.get(2, 0) * tuple.x
                + self.get(2, 1) * tuple.y
                + self.get(2, 2) * tuple.z
                + self.get(2, 3) * tuple.w,
            w: self.get(3, 0) * tuple.x
                + self.get(3, 1) * tuple.y
                + self.get(3, 2) * tuple.z
                + self.get(3, 3) * tuple.w,
        }
    }
}
...
mod tests {
    ...
    fn a_submatrix_of_a_3x3_matrix_is_a_2x2_matrix() {
        let values = [1., 5., 0., -3., 2., 7., 0., 6., -3.];
        let m = Matrix::new_with_values(3, 3, &values);

        let sub_values = [-3., 2., 0., 6.];
    ...
    fn a_submatrix_of_a_4x4_matrix_is_a_3x3_matrix() {
        ...
        let sub_values = [-6., 1., 6., -8., 8., 6., -7., -1., 1.];
